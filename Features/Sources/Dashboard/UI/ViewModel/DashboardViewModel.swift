...
public protocol DashboardExternalFlow {
    ...
    /// When the edit widget button is selected
...
public protocol DashboardViewModel: ObservableObject {
    ...
    // When the user clicks on edit dashboard button
    func didClickEdit(dashboard: Dashboard)
    // When the user clicks on edit widget button
    func didClickEdit(widget: WidgetData)
    // When the user clicks to remove dashboard
    func didClickRemove(dashboard: Dashboard)
    // When the user clicks to remove widget
